...
@section('styles')
    ...
    <link href="{{ asset('user_assets/libs/jquery-toast/jquery.toast.min.js') }}" rel="stylesheet" type="text/css" />
        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item">@lang(trans('cruds.filter.title'))</li>
                    <li class="breadcrumb-item active">@lang('Compare')</li>
                </ol>
            </div>
...
<div class="card">
    <div class="card-header">
        <form method="post" action="{{route('user.compare')}}" onsubmit="return validCount();">
            @csrf
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <button type="submit" class="btn btn-success text-uppercase px-5">@lang('Compare')</button>
                </div>
            </div>
        </form>
    </div>
                ...
                @if(isset($data))
                    ...
                    @foreach($data as $one)
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="button" class="btn btn-xs btn-info" value="@lang('add2compare') +" onclick="addPlayer({{$one->id}})">
                            </td>
                        </tr>
                    @endforeach
                @endif
    ...
    <script>
        ...
        function addPlayer(id) {
            ...
            if(lists.length<4){
                ...
                $('#player'+empty_box).val(id)
                $('#player'+empty_box).select2().trigger('change');
            }
            else
                $.toast({
                    heading: 'Warning',
