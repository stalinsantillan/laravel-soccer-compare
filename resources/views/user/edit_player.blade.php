...
<!-- end page title -->
<form role="form" id="edit_player_form" method="post" action="{{ route('user.store_edt_player', $data->id) }}" enctype="multipart/form-data">
    @csrf
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 row">
                    ...
                    <div class="col-md-5">
                        <input type="range" min="0" value="{{ $data->latestParam->aerial_reach }}" max="{{ $paramsetting->aerial_reach }}" step="0.1"  match="aerial_reach" data-rangeslider>
                    </div>
                </div>
                <div class="form-group col-md-6 row">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 row">
                    ...
                    <div class="col-md-5">
                        <input type="range" min="0" value="{{ $data->latestParam->anticipation }}" max="{{ $paramsetting->anticipation }}" step="0.1"  match="anticipation" data-rangeslider>
                    </div>
                </div>
                <div class="form-group col-md-6 row">
