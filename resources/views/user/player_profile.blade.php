        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('user.filter_player') }}">@lang(trans('cruds.filter.title'))</a></li>
                    <li class="breadcrumb-item active">@lang(trans('cruds.player.profile'))</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="card mb-0">
            <div class="card-header font-16 row" style="padding-top: 0; padding-bottom: 0; min-height: 56px;">
                ...
                <button class="col-md-auto btn btn-link text-white waves-effect ml-5" onclick="openAdditional()">@lang('additional_information')</button>
                <button class="col-md-auto btn btn-link text-white waves-effect" onclick="openScout_Report()">@lang('scout_report')</button>
                <button class="col-md-auto btn btn-link text-white waves-effect" onclick="openInjury();">@lang('Injuries')</button>
                <button class="col-md-auto btn btn-link text-white waves-effect" onclick="openVideo();">@lang('add_video')</button>
                <a href="{{ route('user.edit_player', $data->id) }}" class="btn btn-outline-info waves-effect waves-light ml-2" style="height: 38px; top: 10px">@lang('edit_player')</a>
                @if(\App\Models\User\PDFCount::isPossible())
                    <a href="{{ route('user.player_pdf', $data->id) }}" class="btn btn-outline-info waves-effect waves-light ml-2" style="height: 38px; top: 10px">@lang('export_pdf')</a>
                @else
                                ...
                                <table class="table table-centered mb-0">
                                    <tbody>
                                        ...
                                        @php
                                            ...
                                            {
                                                $team_model = App\Models\User\Team::find($data->current_team_id) ?? null;
                                                if ($team_model)
                                                    $league = $team_model->league->name;
                                            }
                                            else
                                            {
                                                $leagues = App\Models\User\ApiTeam::find($data->current_team_id);
                                                $league = $leagues->competition_name ?? '';
                                            }
                                        @endphp
                                        <td>@lang('League')</td><td>{{$league}}</td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="col-md-7 row">
                        <div class="col-md-4 text-center">
                            ...
                            @foreach($data->positions as $position)
                                @if ($i == 0)
                                    <p class="font-14 text-white mt-3 mb-0">@lang('main_position') : </p>
                                @elseif ($i == 1)
                        ...
                        <div class="col-md-8">
                            ...
                            <table class="table table-centered mb-0 mt-0">
                                <thead>
                                <tr>
                                    <th colspan="2" class="text-center">@lang('best_attributes')</th>
                                </tr>
                                </thead>
                                <tbody id="tbody_best">
                                <tr>
                            ...
                            <table class="table table-centered mb-0 mt-0">
                                <thead>
                                <tr>
                                    <th colspan="2" class="text-center">@lang('worst_attributes')</th>
                                </tr>
                                </thead>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label for="corners">@lang('corners')</label>
                        ...
                        <div class="form-group">
                            <label for="crossing">@lang('crossing')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="dribbling">@lang('dribbling')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="finishing">@lang('finishing')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="aerial_reach">@lang('aerial_reach')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="command_of_area">@lang('command_area')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="eccentricity">@lang('eccentricity')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="first_touch">@lang('first_touch')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="handling">@lang('handling')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="kicking">@lang('kicking')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="one_on_ones">@lang('one_ones')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="feet_playing">@lang('feet_playing')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="free_kick">@lang('free_kick_taking')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="heading">@lang('Heading')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="shots">@lang('Shots')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="long_shots">@lang('long_shots')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="long_throws">@lang('long_throws')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="marking">@lang('Marking')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="passing">@lang('Passing')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="long_pass">@lang('long_pass')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="punching">@lang('Punching')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="reflexes">@lang('Reflexes')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="rushing_out">@lang('rushing_out')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="throwing">@lang('Throwing')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="penalty_taking">@lang('penalty_taking')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="tackling">@lang('Tackling')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="technique">@lang('Technique')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="offensive">@lang('1_1_offensive')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="deffense">@lang('1_1_deffense')</label>
                            <div class="progress mb-2 progress-lg">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label for="aggression">@lang('Aggression')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="anticipation">@lang('Anticipation')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="bravery">@lang('Bravery')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="composure">@lang('Composure')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="concentration">@lang('Concentration')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="decisions">@lang('Decisions')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="determination">@lang('Determination')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="flair">@lang('Flair')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="leadership">@lang('Leadership')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="off_ball">@lang('off_ball')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="positioning">@lang('Positioning')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="teamwork">@lang('Teamwork')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="vision">@lang('Vision')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="work_rate">@lang('work_rate')</label>
                            <div class="progress mb-2 progress-lg">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label for="acceleration">@lang('Acceleration')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="aerial_duels">@lang('aerial_dules')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="agility">@lang('Agility')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="jumping_reach">@lang('jumping_reach')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="natural_fitness">@lang('natural_fitness')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="pace">@lang('Pace')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="reaction">@lang('Reaction')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="sprint_speed">@lang('sprint_speed')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="stamina">@lang('Stamina')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="strength">@lang('Strength')</label>
                            <div class="progress mb-2 progress-lg">
                        ...
                        <div class="form-group">
                            <label for="injury_resistance">@lang('injury_resistance')</label>
                            <div class="progress mb-2 progress-lg">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="card-title font-15 font-weight-bold">
                            @lang('technical_average'): <span id="technical_average"></span>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="dropdown-divider"></div>
                        <div class="card-title font-15 font-weight-bold">
                            @lang('mental_average'): <span id="mental_average"></span>
                        </div>
                        <div class="mt-2 chartjs-chart">
                    ...
                    <div class="col-md-4">
                        <div class="dropdown-divider"></div>
                        <div class="card-title font-15 font-weight-bold">
                            @lang('physical_average'): <span id="physical_average"></span>
                        </div>
                        <div class="mt-2 chartjs-chart">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">@lang('additional_information')</h4>
            ...
            <div class="modal-body p-4">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="language" class="control-label">@lang('Languages')</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="national_team" class="control-label">@lang('national_team')</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="first_appearance_date" class="control-label">@lang('first_appear_na_team')</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="first_appearance_team" class="control-label">@lang('first_appear_fir_devision_team')</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="first_appearance_division" class="control-label">@lang('first_appear_fir_devision')</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="contact_expires" class="control-label">@lang('contract_expires')</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="market_value" class="control-label">@lang('market_value')</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">@lang('Close')</button>
                <button type="button" class="btn btn-info waves-effect waves-light" onclick="saveAdditional()">@lang('save_changes')</button>
            </div>
        </div>
    </div>
</div><!-- /.modal -->
<div id="scout-report" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">@lang('scout_report')</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body p-4">
                <div class="row">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">@lang('Close')</button>
                <button type="button" class="btn btn-info waves-effect waves-light" onclick="saveScout()">@lang('save_changes')</button>
            </div>
        </div>
    </div>
</div><!-- /.modal -->
<div id="injuries-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">@lang('Injuries')</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body p-4">
                <div class="row">
                    ...
                    @foreach ($data->injury as $injury)
                        <div class="form-group" style="border: 1px solid #6f7983; padding: 15px;">
                            ...
                            <label for="injury" class="control-label">@lang('Injury')</label>
                            <input type="text" required class="form-control" value="{{ $injury->injury ?? '' }}" name="injury">
                            <label for="injury_date" class="control-label mt-1">@lang('date_injury')</label>
                            <input type="text" required class="form-control" value="{{ $injury->injury_date ?? '' }}" name="injury_date">
                            <label for="description" class="control-label mt-1">@lang('desc_and_evolution')</label>
                    ...
                    <div class="col-md-12 text-right">
                        <button class="col-md-auto btn btn-link text-white waves-effect" onclick="addInjury()">@lang('add_injury')</button>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">@lang('Close')</button>
                <button type="button" class="btn btn-info waves-effect waves-light" onclick="saveInjury()">@lang('save_changes')</button>
            </div>
        </div>
    </div>
</div><!-- /.modal -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="main_video" class="control-label">@lang('add_link2video')</label>
                            <input type="text" required class="form-control" value="{{ $data->video->main_video ?? '' }}" id="main_video">
                            <label for="another_video" class="control-label mt-1">@lang('add_another_video')</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">@lang('Close')</button>
                <button type="button" class="btn btn-info waves-effect waves-light" onclick="saveVideo()">@lang('save_changes')</button>
            </div>
        </div>
    </div>
</div><!-- /.modal -->
