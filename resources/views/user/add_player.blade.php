                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="form-group row col-md-6">
                            ...
                            <div class="col-md-7">
                                <input type="text" required class="form-control" id="nationality" name="nationality">
                            </div>
                        </div>
                        <div class="form-group row col-md-6">
        ...
        <form role="form" class="parsley-examples">
            <div class="row">
                ...
                <div class="form-group col-md-6 row">
                    ...
                    <div class="col-md-7">
                        <input type="text" required class="form-control" id="main_pos" name="main_pos">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-6 row">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" id="sec_pos" name="sec_pos">
                    </div>
                </div>
                <div class="form-group col-md-6 row">
                    <label for="other_pos" class="col-md-4 col-form-label text-right">
                        Other Position
                    </label>
                    <div class="col-md-7">
                        <input type="text" class="form-control" id="other_pos" name="other_pos">
                    </div>
                </div>
            </div>
        </form>
