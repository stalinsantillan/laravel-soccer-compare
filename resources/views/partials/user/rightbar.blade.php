...
<div class="slimscroll-menu rightbar-content">
    ...
    <!-- Settings -->
    <h5 class="py-2 px-3 bg-secondary">Basic Settings</h5>
    ...
    <!-- Timeline -->
    <h5 class="py-2 px-3 bg-secondary mb-0">Messages <span class="float-right badge badge-pill badge-danger">25</span></h5>
    <div class="p-3">
